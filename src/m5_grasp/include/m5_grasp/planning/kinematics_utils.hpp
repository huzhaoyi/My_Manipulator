...
public:
   ...
   */
  double findValidYaw(double x, double y, double z, double original_yaw,
   ...
   * @return 是否可达
   */
  bool checkJoint23Reachable(const moveit::core::RobotStatePtr& state,
   ...
   */
  YawIKResult tryYawCandidatesForIK(
   ...
   * @brief 计算带yaw的向下姿态
   */
  geometry_msgs::msg::Quaternion computeDownwardOrientationWithYaw(double yaw);
