...
struct GraspParameters {
  ...
  // 预运动参数
  bool auto_move_to_ready{true};
  double ready_joint1{0.0};
  double ready_joint2{-0.5};
  double ready_joint3{-0.5};
  double ready_joint4{0.0};
  double near_zero_threshold{0.1};
};
...
struct WorkspaceParameters {
  ...
  double max_height_offset{0.60};
  double min_height_offset{-0.10};
