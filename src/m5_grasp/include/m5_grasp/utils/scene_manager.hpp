...
class SceneManager
{
  public:
     ...
     * @brief 设置场景参数
     */
    void set_parameters(const std::string& planning_frame, const std::string& eef_link,
                       double cable_diameter, double cable_length, double cable_center_offset_z,
                       double ground_height, double ground_offset_below_base,
     ...
     * @return 是否成功
     */
    bool add_cable_object(const geometry_msgs::msg::PoseStamped& cable_pose, double cable_yaw,
     ...
     * @return 是否成功
     */
    bool attach_object(const std::string& object_id, const std::string& eef_link,
     ...
     * @return 是否成功
     */
    bool detach_and_remove(const std::string& object_id, const std::string& eef_link);
    ...
    make_cable_cylinder_pose(const geometry_msgs::msg::PoseStamped& cable_pose, double cable_yaw);
     ...
     */
    const std::string& get_planning_frame() const
    {
