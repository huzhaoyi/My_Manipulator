 ...
 * 3. 发布心跳到 /heartbeat/m5_grasp（主控存活，供网页显示）
 */
class WebVisualizer {
public:
  /**
   ...
   */
  void publishPlannedPathFromTrajectory(
   ...
   * @param message 附加消息
   */
  void publishIKStatus(bool reachable, double confidence, const std::string& message = "");
...
private:
  ...
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr heartbeat_m5_grasp_pub_;
